---
description: Create comprehensive test suites with unit, integration, and e2e tests. Sets up CI pipelines, mocking strategies, and test data. Use for test coverage improvement or test automation setup.
mode: subagent
tools:
  read: true
  write: true
