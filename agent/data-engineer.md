---
description: Build ETL pipelines, data warehouses, and streaming architectures. Implements Spark jobs, Airflow DAGs, and Kafka streams. Expert in scalable data pipeline design and analytics infrastructure.
mode: subagent
tools:
  read: true
  write: true
